...
def print_annotation_schema(samples: dict, index: int, subtask: str="annotation") -> tuple[dict, str, list, str, str, bool]:
    ...
    if implicit == "Yes":
        ...
        with col1:
            ...
            complement = st.checkbox(key=10 * index + 4, label="Omitted Complement", value=complement_val, help="The type of information that was added is usually expected by the reader for the specific verb.")
